...
CONTROLLER_TYPE = 2 # 1 2 3 4 5 = PID, Mel, INDI, Bres, Lee
TRAJECTORY_COUNT = 1    #   (0=Hover, 1=Line, 2=Sine, 3=Fig8)
no_yaw = False
...
def run_sequence(cf, nnm, positions, HOVER=False):
    commander = cf._cf.high_level_commander
    
    cf._cf.param.set_value('commander.enHighLevel', '1')
    time.sleep(0.1)
    ...
    for pos in positions:
        ...
        commander.go_to(tx, ty, tz, 0, 1.0, relative=False)
        time.sleep(0.5)
...
if __name__ == '__main__':
    ...
    try:
        ...
        run_sequence(cf, nnm, positions, HOVER=HOVER )
